...
<div class="alternative" style=" background-image: url('sfnuovi.jpg');">
    <div class="prom1">
        <div class="prom2">
            <h1 class="titolo" style="color:white !important;">Giochi in uscita</h1>
            <h2 class="sottotitolo" style="color:#e4e4e4 !important;">
                Non vedi l'ora di giocare a un titolo in uscita? Preordina subito la chiave e goditi il gioco che aspettavi non appena disponibile!
            </h2>
        </div>
    </div>
</div>
<div class="prom">
    <div class="container" id="nuovi-container"></div>
</div>
